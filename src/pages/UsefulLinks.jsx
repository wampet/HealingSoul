...
const links = [
  ...
  {
    name: "MedicineNet – Health and Medical Information Produced by Doctors",
  ...
  {
    name: "Senior Veteran’s Service Alliance",
    url: "https://www.veteransaidbenefit.org",
  },
  { name: "American Medical Association", url: "https://www.ama-assn.org" },
  {
    name: "Caregiving – Insights, Information, Inspirations",
    url: "https://www.caregiving.com",
  },
];
...
const UsefulLinks = () => {
  return (
    <div>
      ...
      <div className=" max-w-screen-xl mx-5 md:mx-auto py-8">
