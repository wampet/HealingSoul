...
const TestimonialItem = ({ imageSrc, alt, quote, author, organization }) => (
  <div className="text-center">
    ...
    <blockquote className="text-xl text-gray-heading">{quote}</blockquote>
    <div className="font-red-hat-display font-bold mt-2">
      <cite className="not-italic text-gray-heading">—{author}</cite>, <a className="text-green-500 transition duration-150 ease-in-out" >{organization}</a>
    </div>
  </div>
);
