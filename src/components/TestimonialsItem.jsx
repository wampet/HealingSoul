...
const TestimonialItem = ({ imageSrc, alt, quote, author}) => (
  <div className="text-center">
    ...
    <blockquote className="text-lg italic text-gray-heading">{quote}</blockquote>
    <div className="font-red-hat-display font-bold mt-2">
      <cite className="not-italic text-green-500">—{author}</cite>, <a className="text-green-500 transition duration-150 ease-in-out" ></a>
    </div>
  </div>
);
