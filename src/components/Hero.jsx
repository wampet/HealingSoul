...
function Hero() {
  return (
    <div
      className=" bg-cover  bg-no-repeat text-white relative px-2 py-40 md:py-45 z-[1]"
      style={{
        backgroundImage:
        ...
        <div className="grid grid-cols-12">
          <div className="col-span-12 md:col-span-9 lg:col-span-7 xl:col-span-6">
            ...
            <div className="md:mr-40 lg:mr-72">
              <button className="py-4 px-8 text-bold text-xl text-white font-bold border-green-50 bg-green-50  hover:bg-green-800 rounded-xl w-full">
                Book an Appointment
              </button>
            </div>
          </div>
