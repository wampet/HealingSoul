...
import { Beef as Beef, Map as Map, Shield as Shield } from "lucide-react";
...
const CampaignCard = ({ name, description, Icon }) => (
  <div className="flex flex-col text-gray-heading items-center rounded-xl border hover:bg-green-300 hover:text-white p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10">
